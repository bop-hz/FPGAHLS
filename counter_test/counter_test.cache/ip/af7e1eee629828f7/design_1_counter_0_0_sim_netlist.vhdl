...
axis_tlast_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AEA0AAAAAAAAAAAA"
    )
        port map (
      I0 => \^m00_axis_tlast\,
      I1 => axis_tlast_i_2_n_0,
      I2 => \counter_reg[31]_i_4_n_0\,
      I3 => \^m00_axis_tdata\(5),
      I4 => tx_EN,
      I5 => m00_axis_aresetn,
...
\counter_reg[31]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"8880FFFF"
    )
        port map (
...
\counter_reg[31]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\counter_reg[31]_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      I0 => \^m00_axis_tdata\(13),
      I1 => \^m00_axis_tdata\(12),
...
\counter_reg[31]_i_14\: unisim.vcomponents.LUT6
    generic map(
...
\counter_reg[31]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
        ...
        port map (
      I0 => \counter_reg[31]_i_9_n_0\,
      I1 => \counter_reg[31]_i_10_n_0\,
      I2 => \counter_reg[31]_i_11_n_0\,
      I3 => \counter_reg[31]_i_12_n_0\,
      I4 => \counter_reg[31]_i_13_n_0\,
      I5 => \counter_reg[31]_i_14_n_0\,
      O => \counter_reg[31]_i_4_n_0\
    );
\counter_reg[31]_i_5\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\counter_reg[31]_i_6\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\counter_reg[31]_i_7\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\counter_reg[31]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => \^m00_axis_tdata\(21),
      I1 => \^m00_axis_tdata\(20),
      I2 => \^m00_axis_tdata\(23),
      I3 => \^m00_axis_tdata\(22),
...
\counter_reg_reg[31]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \counter_reg[31]_i_5_n_0\,
      S(2) => \counter_reg[31]_i_6_n_0\,
      S(1) => \counter_reg[31]_i_7_n_0\,
      S(0) => \counter_reg[31]_i_8_n_0\
    );
