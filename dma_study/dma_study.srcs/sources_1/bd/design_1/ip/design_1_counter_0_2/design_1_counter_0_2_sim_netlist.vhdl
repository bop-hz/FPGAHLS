...
-- Date        : Sun Jul 02 20:59:41 2017
-- Host        : LAPTOP-99J5UR38 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/bop/Documents/GitHub/FPGAHLS/dma_study/dma_study.srcs/sources_1/bd/design_1/ip/design_1_counter_0_2/design_1_counter_0_2_sim_netlist.vhdl
-- Design      : design_1_counter_0_2
...
entity design_1_counter_0_2_counter_v1_0_M00_AXIS is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_counter_0_2_counter_v1_0_M00_AXIS : entity is "counter_v1_0_M00_AXIS";
end design_1_counter_0_2_counter_v1_0_M00_AXIS;

architecture STRUCTURE of design_1_counter_0_2_counter_v1_0_M00_AXIS is
...
axis_tlast_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"01000000"
        ...
        port map (
      I0 => \counter_reg[31]_i_7_n_0\,
      I1 => \counter_reg[31]_i_6_n_0\,
      I2 => \counter_reg[31]_i_5_n_0\,
      I3 => \counter_reg[31]_i_4_n_0\,
      I4 => m00_axis_aresetn,
...
\counter_reg[31]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => \^m00_axis_tdata\(29),
      I1 => \^m00_axis_tdata\(16),
      I2 => \^m00_axis_tdata\(28),
      I3 => \^m00_axis_tdata\(26),
...
\counter_reg[31]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
        ...
        port map (
      I0 => \^m00_axis_tdata\(14),
      I1 => \^m00_axis_tdata\(31),
      I2 => \^m00_axis_tdata\(30),
      I3 => \counter_reg[31]_i_14_n_0\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_counter_0_2_counter_v1_0 is
  port (
    m00_axis_tdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
    m00_axis_tvalid : out STD_LOGIC;
    m00_axis_tlast : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_counter_0_2_counter_v1_0 : entity is "counter_v1_0";
end design_1_counter_0_2_counter_v1_0;

architecture STRUCTURE of design_1_counter_0_2_counter_v1_0 is
begin
counter_v1_0_M00_AXIS_inst: entity work.design_1_counter_0_2_counter_v1_0_M00_AXIS
     port map (
      EN => EN,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_counter_0_2 is
  port (
    EN : in STD_LOGIC;
    m00_axis_tdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  attribute NotValidForBitStream of design_1_counter_0_2 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_counter_0_2 : entity is "design_1_counter_0_2,counter_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_counter_0_2 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_counter_0_2 : entity is "counter_v1_0,Vivado 2016.4";
end design_1_counter_0_2;

architecture STRUCTURE of design_1_counter_0_2 is
begin
  m00_axis_tstrb(0) <= 'Z';
  m00_axis_tstrb(1) <= 'Z';
  m00_axis_tstrb(2) <= 'Z';
  m00_axis_tstrb(3) <= 'Z';
inst: entity work.design_1_counter_0_2_counter_v1_0
     port map (
      EN => EN,
      m00_axis_aclk => m00_axis_aclk,
      m00_axis_aresetn => m00_axis_aresetn,
